...
export class App extends React.Component {
  ...
  componentDidMount() {
    const contactsFormStorage = JSON.parse(localStorage.getItem('contacts'));

    if(contactsFormStorage) {
      this.setState({ contacts: contactsFormStorage });

        if(contactsFormStorage.length === 0) {
